...
4. Build, and read the summary and the [findings](../../objects/quality/finding.md): the dictionary of that locale is built from the titles and aliases of its entities and the pack's stopwords, its occurrences are scanned with the pack's normalisation, and its index collates with its rules.

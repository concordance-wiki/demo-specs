...
6. Print the [findings](../../objects/quality/finding.md), local and global merged without repetition, as text, JSON, SARIF or JUnit, each with the address of its documentation page; the JSON and SARIF reports name the scope and say when the global scope was degraded.

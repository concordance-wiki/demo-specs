...
The section of the [entity page](entity-page.md) of an API whose contract the build imported. It shows the contract next to the note without copying anything into the markdown: what the [model](../objects/model.md) knows of the contract stands in the served HTML, and the signatures load on demand.
...
- [Operation matching](../rules/operation-matching.md)
- [Operation unmatched](../rules/operation-unmatched.md)

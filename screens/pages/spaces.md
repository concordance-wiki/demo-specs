...
The "Spaces" link of the top bar and the "SPACES" entry of the drawer lead here; on a phone the table gives up its content column and its heading row, each row reading the badge and the title, then the count and the date.
